...
import com.db.loancalculatordb.databinding.ActivityPpfCalcBinding;

import java.text.DecimalFormat;

public class PpfCalcActivity extends AppCompatActivity {
    ActivityPpfCalcBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityPpfCalcBinding.inflate(getLayoutInflater());
