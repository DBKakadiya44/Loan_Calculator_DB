...
import com.db.loancalculatordb.databinding.ActivityRdCalcBinding;

import java.text.DecimalFormat;

public class RdCalcActivity extends AppCompatActivity {
    ActivityRdCalcBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityRdCalcBinding.inflate(getLayoutInflater());
