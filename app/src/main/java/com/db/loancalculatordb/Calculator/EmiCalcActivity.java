...
import com.db.loancalculatordb.databinding.ActivityEmiCalcBinding;

import java.text.DecimalFormat;
import java.util.ArrayList;

public class EmiCalcActivity extends AppCompatActivity {
    ActivityEmiCalcBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityEmiCalcBinding.inflate(getLayoutInflater());
