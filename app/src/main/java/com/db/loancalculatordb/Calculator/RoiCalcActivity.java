...
import com.db.loancalculatordb.databinding.ActivityRoiCalcBinding;

import java.text.DecimalFormat;

public class RoiCalcActivity extends AppCompatActivity {
    ActivityRoiCalcBinding binding;
    ...
    EditText et_tenure_year,et_tenure_month;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityRoiCalcBinding.inflate(getLayoutInflater());
        ...
        et_tenure_year = (EditText) findViewById(R.id.et_tenure_year);
        et_tenure_month = (EditText) findViewById(R.id.et_tenure_month);
    ...
    public void getEMI() {
        ...
        } else if (TextUtils.isEmpty(et_tenure_year.getText().toString())) {
            et_tenure_year.setError("Enter Years Or Months");
        }  else if (TextUtils.isEmpty(et_tenure_month.getText().toString())) {
            et_tenure_month.setError("Enter Years Or Months");
        } else {
    ...
    private int getMonth() {
        if (TextUtils.isEmpty(et_tenure_year.getText().toString())) {
            return 0;
        }
        return Integer.parseInt((Integer.parseInt(et_tenure_year.getText().toString()) * 12) + et_tenure_month.getText().toString());
    }
    ...
    public void clearFields() {
        try {
            ...
            et_interest.setText("");
            et_tenure_year.setText("");
            et_tenure_month.setText("");
            monthOrYear = 2;
