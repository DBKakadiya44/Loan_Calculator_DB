...
import com.db.loancalculatordb.databinding.ActivitySwpCalcBinding;

import java.text.DecimalFormat;

public class SwpCalcActivity extends AppCompatActivity {
    ActivitySwpCalcBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivitySwpCalcBinding.inflate(getLayoutInflater());
