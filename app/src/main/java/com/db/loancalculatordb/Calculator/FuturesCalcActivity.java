...
import com.db.loancalculatordb.databinding.ActivityFuturesCalcBinding;

public class FuturesCalcActivity extends AppCompatActivity {
    ActivityFuturesCalcBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityFuturesCalcBinding.inflate(getLayoutInflater());
