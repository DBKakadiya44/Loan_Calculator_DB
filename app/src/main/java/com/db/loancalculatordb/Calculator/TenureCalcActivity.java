...
import com.db.loancalculatordb.databinding.ActivityTenureCalcBinding;

import java.text.DecimalFormat;

public class TenureCalcActivity extends AppCompatActivity {
    ActivityTenureCalcBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityTenureCalcBinding.inflate(getLayoutInflater());
