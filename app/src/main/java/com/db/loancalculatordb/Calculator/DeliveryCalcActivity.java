...
import com.db.loancalculatordb.databinding.ActivityDeliveryCalcBinding;

public class DeliveryCalcActivity extends AppCompatActivity {
    ActivityDeliveryCalcBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityDeliveryCalcBinding.inflate(getLayoutInflater());
