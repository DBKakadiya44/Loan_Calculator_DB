...
import com.db.loancalculatordb.databinding.ActivityCompoundCalcBinding;

import java.text.DecimalFormat;

public class CompoundCalcActivity extends AppCompatActivity {
    ActivityCompoundCalcBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityCompoundCalcBinding.inflate(getLayoutInflater());
