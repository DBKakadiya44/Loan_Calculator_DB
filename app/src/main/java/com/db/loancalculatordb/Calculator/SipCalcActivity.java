...
import com.db.loancalculatordb.databinding.ActivitySipCalcBinding;

import java.text.DecimalFormat;

public class SipCalcActivity extends AppCompatActivity {
    ActivitySipCalcBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivitySipCalcBinding.inflate(getLayoutInflater());
        ...
        tv_emi = (TextView) findViewById(R.id.Monthly_EMI);
    ...
    private void displayResult(double d, double d2, int i) {
        ...
        tv_emi.setText(decimalFormat.format(d));
