...
import com.db.loancalculatordb.databinding.ActivityOptionCalcBinding;

public class OptionCalcActivity extends AppCompatActivity {
    ActivityOptionCalcBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityOptionCalcBinding.inflate(getLayoutInflater());
